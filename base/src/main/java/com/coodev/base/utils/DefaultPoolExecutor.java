...
public class DefaultPoolExecutor extends ThreadPoolExecutor {
    ...
    public static DefaultPoolExecutor getInstance() {
        if (null == instance) {
            synchronized (com.alibaba.android.arouter.thread.DefaultPoolExecutor.class) {
                if (null == instance) {
    ...
    protected void afterExecute(Runnable r, Throwable t) {
        ...
        if (t != null) {
            Log.w("DefaultPoolExecutor",
                    "Running task appeared exception! Thread [" + Thread.currentThread().getName() + "], because [" + t.getMessage() + "]\n" + com.alibaba.android.arouter.utils.TextUtils.formatStackTrace(t.getStackTrace()));
        }
    }
}